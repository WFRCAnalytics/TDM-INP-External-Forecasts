...
Truck vs. passenger split (`TRUCK_SU`/`TRUCK_MU`/`PASSENGER`) uses UDOT's `SUTRK`/`CUTRK`
percentages through 2024, then switches to a per-station regression of truck volume against
AADT (not year) for 2025 onward — see `project_future_volumes`.
